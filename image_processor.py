...
class ImageProcessor:
    ...
    def __init__(self):
        ...
        self.textCorrector = TextCorrector('./pn/ru_RU.dic', './pn/ru_RU.aff', './pn/en_US.dic', './pn/en_US.aff')
    ...
    def debug_save_txt(self, text, ocr, image_path):
        output_dir = "output"
        image_name = file_name = os.path.splitext(os.path.basename(image_path))[0]
        file_name = f"{image_name}_{ocr}.txt"
    ...
    def process_image(self, image_path: str) -> str:
        ...
        try:
            ...
            self.debug_save_txt(corrected_text_tesseract, "tesseract", image_path)
            processed_text = self.process_text(corrected_text)
            self.debug_save_txt(processed_text, "easyocr", image_path)
            processed_text_tesseract = self.process_text(corrected_text_tesseract)
            self.debug_save_txt(processed_text_tesseract, "easyocr", image_path)
